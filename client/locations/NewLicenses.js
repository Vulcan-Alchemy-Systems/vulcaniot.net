    ...
    Meteor.call('updateLocation',
      ...
      function (error) {
        if(error) {
          ...
          $("#alert").html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Licenses have been saved.</div>');
